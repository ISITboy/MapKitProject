...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var animation: com.example.mapkitresultproject.presentation.mapscreen.Animation
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        animation = com.example.mapkitresultproject.presentation.mapscreen.Animation(this)
